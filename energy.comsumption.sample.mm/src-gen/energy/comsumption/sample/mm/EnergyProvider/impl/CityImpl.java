 ...
 * </p>
 * <ul>
 *   <li>{@link energy.comsumption.sample.mm.EnergyProvider.impl.CityImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CityImpl extends MinimalEObjectImpl.Container implements City {
	...
	protected EClass eStaticClass() {
		return EnergyConsumptionPackage.Literals.CITY;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EnergyConsumptionPackage.CITY__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case EnergyConsumptionPackage.CITY__NAME:
			return getName();
		}
