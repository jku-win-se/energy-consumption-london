...
class EnergyConsumptionImporter_4000 {
	...
	void test() {
			...
			//Path
			java.net.URI root = FileSystems.getDefault().getPath("data").resolve("LCLModel_4000.ec").toAbsolutePath().toUri();
			...
			for (CSVRecord record : records) {
		        ...
		        if (energyProvider.getElectricalEnergyConsumption().size() == 4000) 
		        	break;
		    }			
